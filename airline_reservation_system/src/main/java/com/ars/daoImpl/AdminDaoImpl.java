...
public class AdminDaoImpl implements AdminDao{
	...
	@Override
	public void registerAdmin(Admin admin)   //for registerAdmin
	{
	...
	@Override
	public boolean loginAdmin(String userName, String password)   // for loginAdmin
	{
		Session session=HibernateUtil.getSession();
		...
		return false;
			...
			@Override
			public Admin getAdminById(int id)   //method for get admin in DAO layer 
			{
